...
- [Deep cryo-EM Map Enhancer (DeepEMhancer)](#deep-cryo-em-map-enhancer-deepemhancer)
  ...
  - [Usage guide](#usage-guide)
        - [About the input](#about-the-input)
        - [About the deep learning models (-p option)](#about-the-deep-learning-models--p-option)
        - [About the normaliztion](#about-the-normaliztion)
        - [About the batch size](#about-the-batch-size)
  - [Examples](#examples)
  - [TROUBLESHOOTING](#troubleshooting)
...
1) Activate the environment. You always need to activate the environment before executing deepEMhancer
...
1) Download our deep learning models

```
deepemhancer --download
```

1) Ready! Do not forget to activate the environment for future usages. For a complete help use:
...
1) Optionally, you can remove the folder, since deepemhancer will be available anywhere once you activate the environment
...
1) Install deepEMhancer (using Tensorflow 1.14)
...
1) Ready! Do not forget to activate the environment, if used (step 1.1), for future usages. For a complete help use:
